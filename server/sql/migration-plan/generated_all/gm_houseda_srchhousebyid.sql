...
-- Source file: GM_HouseDA_SrchHouseById.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_houseda_srchhousebyid(_id INTEGER)
RETURNS SETOF RECORD  -- TODO: replace with explicit RETURNS TABLE(col TYPE, ...)
LANGUAGE plpgsql AS $$
BEGIN
/*

			EXEC GM_HouseDA_SrchHouseById _id = 700012076
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_houseda_srchhousebyid;
-- +goose StatementEnd
