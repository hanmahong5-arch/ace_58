...
-- Source file: aion_AddCharRankPoint.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_addcharrankpoint(_char_id INTEGER, _rank_id INTEGER, _point_to_add INTEGER)
RETURNS VOID
LANGUAGE plpgsql AS $$
BEGIN
begin
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_addcharrankpoint;
-- +goose StatementEnd
