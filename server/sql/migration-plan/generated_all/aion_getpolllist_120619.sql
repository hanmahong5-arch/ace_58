...
-- Source file: aion_GetPollList_120619.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getpolllist_120619(_curr_time INTEGER, _poll_version INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getpolllist_120619;
-- +goose StatementEnd
