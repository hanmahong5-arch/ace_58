...
-- Source file: aion_GetItemEnchant_20150921.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getitemenchant_20150921(_itemid BIGINT)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getitemenchant_20150921;
-- +goose StatementEnd
