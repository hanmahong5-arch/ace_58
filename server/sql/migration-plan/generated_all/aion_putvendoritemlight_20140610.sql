...
-- Source file: aion_PutVendorItemLight_20140610.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_putvendoritemlight_20140610(_char_id INTEGER, _user_item_id BIGINT, _user_price BIGINT, _sale_price BIGINT, _commit_amount BIGINT, _remain_amount BIGINT, _commit_date INTEGER, _buy_partial INTEGER)
RETURNS INTEGER
LANGUAGE plpgsql AS $$
BEGIN
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_putvendoritemlight_20140610;
-- +goose StatementEnd
