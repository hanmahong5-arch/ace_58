...
-- Source file: aion_GetVendorItemListAllDark_20140610.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getvendoritemlistalldark_20140610(_warehouse INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getvendoritemlistalldark_20140610;
-- +goose StatementEnd
