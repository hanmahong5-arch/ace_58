...
BEGIN
	...
	if @_rowcount = 0 
		...
		, magicalDefend, magicalSkillBoostResist, baseMagicalDefend, baseMagicalSkillBoostResist, mpHealSkillBoost, baseMpHealSkillBoost, json
		...
		_magical_defend, _magical_skill_boost_resist, _base_magical_defend, _base_magical_skill_boost_resist, _heal_skill_boost, _base_mp_heal_skill_boost, _json
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_setcharstat_new_20171204;
-- +goose StatementEnd
