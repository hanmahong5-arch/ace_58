...
-- Source file: aion_ChangeGuildNameByGM.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_changeguildnamebygm(_guild_id INTEGER, _new_guild_name TEXT)
RETURNS INTEGER
LANGUAGE plpgsql AS $$
BEGIN
-- 중복길드명
...
--values(2, 5, _server_i_d, _old_guild_name, 0, 'UseItem', 'ChangeGuildName', NOW(), 0)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_changeguildnamebygm;
-- +goose StatementEnd
