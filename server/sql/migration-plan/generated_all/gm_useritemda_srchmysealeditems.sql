...
-- Source file: GM_UserItemDA_SrchMySealedItems.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_useritemda_srchmysealeditems(_char_id TEXT)
...
set transaction isolation level read uncommitted
			...
			SELECT	-- user_item
					...
					, sealexpiredtime, sealstate, expire_dye_time
			...
			JOIN	user_item_sealed s (nolock) ON s.id = i.id
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_useritemda_srchmysealeditems;
-- +goose StatementEnd
