...
-- Source file: aion_GetVendorItemListAllDark_20151109.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getvendoritemlistalldark_20151109(_warehouse INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getvendoritemlistalldark_20151109;
-- +goose StatementEnd
