...
-- Source file: GM_GuildDA_SrchGuildItem.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_guildda_srchguilditem(_guild_id TEXT, _warehouse TEXT)
...
set transaction isolation level read uncommitted
			...
			SELECT	i.producer, i.tid, i.expired_time, i.buy_amount, i.buy_duration, i.id, i.name_id, i.amount, i.slot, i.warehouse

					, soul_bound, enchant_count, skin_name_id, stat_enchant_name0, stat_enchant_name1, stat_enchant_name2, stat_enchant_name3, stat_enchant_name4, stat_enchant_name5, option_count, dye_info, proc_tool_nameid, obtain_skin_type, expire_skin_time, expire_dye_time, COALESCE(random_option,0) AS random_option
			...
			FROM	guild g (nolock), user_item i (nolock)
			...
			WHERE	g.id = _guild_id and g.id = i.char_id and (i.warehouse = _warehouse or i.warehouse = '53');
END;
$$;
-- +goose StatementEnd
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_guildda_srchguilditem;
-- +goose StatementEnd
