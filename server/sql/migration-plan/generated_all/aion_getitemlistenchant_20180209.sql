...
-- Source file: aion_GetItemListEnchant_20180209.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getitemlistenchant_20180209(_char_id INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getitemlistenchant_20180209;
-- +goose StatementEnd
