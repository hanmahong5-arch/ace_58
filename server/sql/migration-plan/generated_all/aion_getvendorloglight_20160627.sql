...
-- Source file: aion_GetVendorLogLight_20160627.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getvendorloglight_20160627(_char_id INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getvendorloglight_20160627;
-- +goose StatementEnd
