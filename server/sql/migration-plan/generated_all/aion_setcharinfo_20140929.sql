...
-- Source file: aion_SetCharInfo_20140929.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_setcharinfo_20140929(_char_i_d INTEGER, _class INTEGER, _guild_id INTEGER, _guild_rank INTEGER, _recreate_guild_time INTEGER, _cur_server INTEGER, _world INTEGER, _world_map_number INTEGER, _xlocation DOUBLE PRECISION, _ylocation DOUBLE PRECISION, _zlocation DOUBLE PRECISION, _dir INTEGER, _last_normal_world INTEGER, _last_normal_xlocation DOUBLE PRECISION, _last_normal_ylocation DOUBLE PRECISION, _last_normal_zlocation DOUBLE PRECISION, _last_normal_dir INTEGER, _death_count INTEGER, _temporary_lost_exp BIGINT, _resurrect_world INTEGER, _resurrect_xlocation DOUBLE PRECISION, _resurrect_ylocation DOUBLE PRECISION, _resurrect_zlocation DOUBLE PRECISION, _hp INTEGER, _mp INTEGER, _fp INTEGER, _exp BIGINT, _abyss_point BIGINT, _abyss_point_from_user BIGINT, _level INTEGER, _stigma_point INTEGER, _cur_title_id INTEGER, _cur_title_attr_id INTEGER, _guild_intro TEXT, _guild_nick_name TEXT, _today_compare_time INTEGER, _today_abyss_kill_cnt INTEGER, _today_abyss_point BIGINT, _this_week_compare_time INTEGER, _this_week_abyss_kill_cnt INTEGER, _this_week_abyss_point BIGINT, _last_week_abyss_kill_cnt INTEGER, _last_week_abyss_point BIGINT, _total_abyss_kill_cnt INTEGER, _best_abyss_rank INTEGER, _freefly INTEGER, _optionflags INTEGER, _accused_count INTEGER, _last_accuse_time INTEGER, _bot_point INTEGER, _vital_point BIGINT, _pvp_exp BIGINT, _serial_kill_point INTEGER, _serial_kill_duration INTEGER, _serial_kill_penalty_skill_rank INTEGER, _enhanced_stigma_slot_cnt INTEGER, _housing_id INTEGER, _fatigue_resttime_online INTEGER, _next_hotspot_use_time BIGINT, _gotcha_fever_point INTEGER, _gotcha_fever_expire_time BIGINT, _last_explicit_beginner_force INTEGER, _absolute_exp BIGINT, _serial_guard_point INTEGER, _serial_guard_last_scantime INTEGER)
RETURNS VOID
LANGUAGE plpgsql AS $$
BEGIN
UPDATE user_data 
...
SET 	class = _class,
	...
	guild_id = _guild_id, guild_rank = _guild_rank, 
	...
	today_compare_time = _today_compare_time, 

	today_abyss_kill_cnt = _today_abyss_kill_cnt, today_abyss_point = _today_abyss_point,

	this_week_compare_time = _this_week_compare_time, 
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_setcharinfo_20140929;
-- +goose StatementEnd
