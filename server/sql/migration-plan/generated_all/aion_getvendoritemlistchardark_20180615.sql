...
-- Source file: aion_GetVendorItemListCharDark_20180615.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getvendoritemlistchardark_20180615(_user_id INTEGER, _warehouse INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getvendoritemlistchardark_20180615;
-- +goose StatementEnd
