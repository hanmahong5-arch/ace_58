...
-- Source file: aion_GetItemListEnchant_20150429.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getitemlistenchant_20150429(_char_id INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getitemlistenchant_20150429;
-- +goose StatementEnd
