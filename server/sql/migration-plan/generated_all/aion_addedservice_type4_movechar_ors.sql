...
-- Source file: aion_AddedService_Type4_MoveChar_ORS.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_addedservice_type4_movechar_ors(_server_id INTEGER, _db_user_id TEXT, _db_passwd TEXT)
RETURNS INTEGER
LANGUAGE plpgsql AS $$
BEGIN
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_addedservice_type4_movechar_ors;
-- +goose StatementEnd
