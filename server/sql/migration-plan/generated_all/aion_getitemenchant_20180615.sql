...
-- Source file: aion_GetItemEnchant_20180615.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getitemenchant_20180615(_itemid BIGINT)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getitemenchant_20180615;
-- +goose StatementEnd
