...
-- Source file: aion_GetVendorItemListCharDark_20140610.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getvendoritemlistchardark_20140610(_user_id INTEGER, _warehouse INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getvendoritemlistchardark_20140610;
-- +goose StatementEnd
