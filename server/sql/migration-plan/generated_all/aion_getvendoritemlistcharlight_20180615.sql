...
-- Source file: aion_GetVendorItemListCharLight_20180615.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getvendoritemlistcharlight_20180615(_user_id INTEGER, _warehouse INTEGER)
...
BEGIN
	...
	SELECT vendor_item_light.id, user_item.id, user_item.name_id, vendor_item_light.user_price, 
		...
		vendor_item_light.can_buy_partial, vendor_item_light.afterUnitFee, vendor_item_light.afterUnitTax,
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getvendoritemlistcharlight_20180615;
-- +goose StatementEnd
