...
-- Source file: GM_UserItemDA_SrchCurLightVendorItems.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_useritemda_srchcurlightvendoritems(_warehouse TEXT, _name_id TEXT, _char_nm TEXT, _char_id TEXT, _from_name_id TEXT, _to_name_id TEXT, _view_count TEXT, _top_count TEXT, _world_id TEXT)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_useritemda_srchcurlightvendoritems;
-- +goose StatementEnd
