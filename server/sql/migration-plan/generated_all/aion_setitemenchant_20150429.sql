...
-- Source file: aion_SetItemEnchant_20150429.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_setitemenchant_20150429(_id BIGINT, _soul_bound INTEGER, _enchant_count INTEGER, _skin_name_id INTEGER, _stat_enchant_name0 INTEGER, _stat_enchant_name1 INTEGER, _stat_enchant_name2 INTEGER, _stat_enchant_name3 INTEGER, _stat_enchant_name4 INTEGER, _stat_enchant_name5 INTEGER, _proc_tool_name_id INTEGER, _obtain_skin_type INTEGER, _expire_skin_time INTEGER, _limit_enchant_count INTEGER, _authorize_count INTEGER, _vanish_point INTEGER, _enchant_prob_addition INTEGER, _option_prob_addition INTEGER, _name_id INTEGER, _exceed_state INTEGER, _exceed_skill_id1 INTEGER, _exceed_skill_id2 INTEGER, _exceed_skill_id3 INTEGER, _base_skill_id INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_setitemenchant_20150429;
-- +goose StatementEnd
