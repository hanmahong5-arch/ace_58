...
-- Source file: aion_AddedService_Type4_MoveChar_ORS_DIRECT_TEST.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_addedservice_type4_movechar_ors_direct_test(_server_id INTEGER, _db_user_id TEXT, _db_passwd TEXT, _service_db_idx INTEGER)
RETURNS INTEGER
LANGUAGE plpgsql AS $$
BEGIN
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_addedservice_type4_movechar_ors_direct_test;
-- +goose StatementEnd
