...
-- Source file: GM_UserDataDAO_InsertUpdateGPAbsolute.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_userdatadao_insertupdategpabsolute(_char_id INTEGER, _glory_point INTEGER)
RETURNS VOID
LANGUAGE plpgsql AS $$
BEGIN
BEGIN
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_userdatadao_insertupdategpabsolute;
-- +goose StatementEnd
