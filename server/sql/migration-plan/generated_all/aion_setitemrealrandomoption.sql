...
-- Source file: aion_SetItemRealRandomOption.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_setitemrealrandomoption(_item_id BIGINT, _random_attr1 INTEGER, _random_value1 INTEGER, _random_attr2 INTEGER, _random_value2 INTEGER, _random_attr3 INTEGER, _random_value3 INTEGER, _random_attr4 INTEGER, _random_value4 INTEGER, _random_attr5 INTEGER, _random_value5 INTEGER, _random_attr6 INTEGER, _random_value6 INTEGER, _random_attr7 INTEGER, _random_value7 INTEGER, _random_attr8 INTEGER, _random_value8 INTEGER, _random_attr9 INTEGER, _random_value9 INTEGER, _random_attr10 INTEGER, _random_value10 INTEGER)
RETURNS VOID
LANGUAGE plpgsql AS $$
BEGIN
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_setitemrealrandomoption;
-- +goose StatementEnd
