...
-- Source file: aion_GetCharInfo_ForRefreshAcc_20160303.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getcharinfo_forrefreshacc_20160303(_user_id INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getcharinfo_forrefreshacc_20160303;
-- +goose StatementEnd
