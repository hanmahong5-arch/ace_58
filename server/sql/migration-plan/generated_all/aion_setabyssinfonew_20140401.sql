...
begin		
	...
	BEGIN
		...
		INSERT abyss (abyss_id, owner_server, owner_guild, owner_race, defense_count, reward, occupy_bonus, user_reward_sum, change_owner_time, last_ownership_bonus_gp, last_pvp_on_time, occupy_point, occupy_count) VALUES (_abyss_id, _owner_server, _owner_guild, _owner_race, _defense_cnt, _reward, _occupy_bonus, _user_reward_sum, _change_owner_time, _ownership_bonus_glory_point, _last_pv_p_on_time, _occupy_point, _occupy_count)
	...
	BEGIN
		...
		INSERT abyss (abyss_id, owner_server, owner_guild, owner_race, defense_count, reward, occupy_bonus, user_reward_sum, change_owner_time, last_ownership_bonus_gp, last_pvp_on_time, occupy_point, occupy_count) VALUES (_abyss_id, _owner_server, _owner_guild, _owner_race, _defense_cnt, _reward, _occupy_bonus, _user_reward_sum, _change_owner_time, 0, _last_pv_p_on_time, _occupy_point, _occupy_count)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_setabyssinfonew_20140401;
-- +goose StatementEnd
