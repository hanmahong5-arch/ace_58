...
-- Source file: aion_PutVendorItemDark_20160627.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_putvendoritemdark_20160627(_char_id INTEGER, _user_item_id BIGINT, _user_price BIGINT, _sale_price BIGINT, _commit_amount BIGINT, _remain_amount BIGINT, _commit_date INTEGER, _buy_partial INTEGER, _after_unit_fee BIGINT, _after_unit_tax BIGINT)
RETURNS INTEGER
LANGUAGE plpgsql AS $$
BEGIN
BEGIN
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_putvendoritemdark_20160627;
-- +goose StatementEnd
