...
-- Source file: GM_UserItemDA_SrchMyPetItem.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_useritemda_srchmypetitem(_char_id TEXT, _from_warehouse TEXT, _to_warehouse TEXT)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_useritemda_srchmypetitem;
-- +goose StatementEnd
