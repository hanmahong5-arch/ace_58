...
-- Source file: aion_GetItemListEnchant_20180615.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getitemlistenchant_20180615(_char_id INTEGER)
...
COALESCE(stat_enchant_name0, 0), 
	...
	COALESCE(COALESCE(skill_skin_name_Id, skin_name_id), 0)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getitemlistenchant_20180615;
-- +goose StatementEnd
