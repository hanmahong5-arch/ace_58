...
-- Source file: GM_UserItemDA_SrchMyItemByCharIDandWarehouse.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_useritemda_srchmyitembycharidandwarehouse(_char_id TEXT, _db_id TEXT, _warehouse TEXT)
...
-- TODO: unsupported T-SQL construct: sp_executesql
			...
			_sql := -- user_item
						...
						' WHERE	(i.char_id = '''+_char_id+''') and warehouse='''+_warehouse+''' '
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_useritemda_srchmyitembycharidandwarehouse;
-- +goose StatementEnd
