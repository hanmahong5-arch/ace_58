...
-- Source file: aion_GetCharInfo_Ext_20180222.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getcharinfo_ext_20180222(_char_id INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getcharinfo_ext_20180222;
-- +goose StatementEnd
