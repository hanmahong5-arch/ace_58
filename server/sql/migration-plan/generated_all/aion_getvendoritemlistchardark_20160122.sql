...
-- Source file: aion_GetVendorItemListCharDark_20160122.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getvendoritemlistchardark_20160122(_user_id INTEGER, _warehouse INTEGER)
...
SELECT vendor_item_dark.id, user_item.id, user_item.name_id, vendor_item_dark.user_price, 
	...
	vendor_item_dark.can_buy_partial,
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getvendoritemlistchardark_20160122;
-- +goose StatementEnd
