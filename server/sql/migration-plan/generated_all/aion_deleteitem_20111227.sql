...
-- Source file: aion_DeleteItem_20111227.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_deleteitem_20111227(_id BIGINT)
RETURNS VOID
LANGUAGE plpgsql AS $$
BEGIN
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_deleteitem_20111227;
-- +goose StatementEnd
