...
-- Source file: aion_OrderingAbyssRanking_20140827.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_orderingabyssranking_20140827(_special_svr INTEGER, _server_id INTEGER, _race INTEGER, _time BIGINT, _num INTEGER)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_orderingabyssranking_20140827;
-- +goose StatementEnd
