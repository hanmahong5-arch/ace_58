...
-- Source file: aion_PutGuild_20150428.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_putguild_20150428(_guild_name TEXT, _master_id INTEGER, _race INTEGER, _sub_master_right INTEGER, _officer_right INTEGER, _member_right INTEGER, _newbie_right INTEGER, _join_process_type INTEGER, _join_restrict_level INTEGER)
...
INSERT guild (name, race, master_id, level, rank, submaster_right, officer_right, member_right, newbie_right, point, fund, delete_requested, delete_time, notice1, notice2, notice3, notice4, notice5, notice6, notice7, change_info_time, intro, join_process_type, join_restrict_level) 

VALUES (_guild_name, _race, _master_id, 1, 0, _sub_master_right, _officer_right, _member_right, _newbie_right, 0, 0, 0, 0, '', '', '', '', '', '', '', GetUnixtimeWithUTCAdjust((NOW() AT TIME ZONE 'UTC'),0), '', _join_process_type, _join_restrict_level)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_putguild_20150428;
-- +goose StatementEnd
