...
-- Source file: GM_UserItemDA_SrchMyPolishedItems.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION gm_useritemda_srchmypolisheditems(_char_id TEXT)
...
set transaction isolation level read uncommitted
			...
			AND		(i.warehouse = 0/*인벤*/ OR i.warehouse BETWEEN 20 AND 49/*펫*/ OR i.warehouse BETWEEN 60 AND 79/*하우스*/)

			AND		(i.name_id BETWEEN 100000000 AND 102999999	/*무기만 연마가능*/)
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS gm_useritemda_srchmypolisheditems;
-- +goose StatementEnd
