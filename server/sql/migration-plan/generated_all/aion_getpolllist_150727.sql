...
-- Source file: aion_GetPollList_150727.sql
-- Review TODOs before deploying.

-- +goose Up
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION aion_getpolllist_150727(_curr_time INTEGER, _poll_version INTEGER)
...
select poll_id, base_poll_id, status , priority, start_time, end_time, race_restriction, class_restriction, reward_item_count, 
	...
	,COALESCE(vip_grade_restriction, '') as vip_grade_restriction, game_exprience_lv_restriction, playtime_restriction
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_getpolllist_150727;
-- +goose StatementEnd
