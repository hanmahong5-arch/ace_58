...
insert into poll_info (poll_Id, base_poll_id, status, priority, start_time, end_time, race_restriction, class_restriction, 
	...
	bmAccountType_restriction, bmPackType_restriction, inter_server_type, promtion_target_restriction, game_exprience_lv_restriction)
...
values (_poll_id, _base_poll_id, _status, _priority, _start_time, _end_time, _race_restriction, _class_restriction, 
	...
	_bm_account_type_restriction, _bm_pack_type_restriction, _inter_svr_type, _promtion_target_restriction, _game_exprience_lv_restriction);
END;
$$;
-- +goose StatementEnd
...
-- +goose Down
-- +goose StatementBegin
DROP FUNCTION IF EXISTS aion_putpollinfo_120619;
-- +goose StatementEnd
